...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    return img, gt, label_values, label_true_queue, ignored_labels, rgb_bands, palette
...
def create_dataloader(args, DEVICE):
    img_src, gt_src, LABEL_VALUES_src, label_true_queue, IGNORED_LABELS, RGB_BANDS, palette = get_dataset(args.source_name,
                                                                                                     args.data_path)
    img_tar, gt_tar, LABEL_VALUES_tar, _, IGNORED_LABELS, RGB_BANDS, palette = get_dataset(args.target_name,
                                                                                                     args.data_path)
